...
<form:form action="estilo/administrator/edit.do" modelAttribute="estilo">
    <form:hidden path="id" />
    ...
    <c:if test="${estilo.id != 0}">
        <input type="submit" name="delete" value="<spring:message code="estilo.delete" />"
