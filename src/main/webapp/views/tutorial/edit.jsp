...
<form:form action="tutorial/academia/edit.do" modelAttribute="tutorial">
	...
	<label for="titulo"> <spring:message code="tutorial.titulo" />:
	</label>
	...
	<label for="visitas"> 
	<spring:message code="tutorial.visitas" />:
	</label>
	<form:input path="visitas" id="visitas" />
	<form:errors cssClass="error" path="visitas" />
	<br />
	...
	<a href="<spring:url value='/tutorial/academia/list.do' />"> <input
